    ...
    try {
      l(void 0, void 0, void 0, function() {
        ...
        return f(this, function(n3) {
          switch (n3.label) {
            case 0:
              return [4, createKindeClient({ audience: r2, scope: h2, client_id: v2, domain: b, is_dangerously_use_local_storage: k, redirect_uri: O, logout_uri: F, on_redirect_callback: _, _framework: "React", _frameworkVersion: "3.0.27" })];
            case 1:
